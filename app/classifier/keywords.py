...
class KeyWords:
    ...
    stop_dot_keywords = {
        'Блок питания': ['зарядный', 'питание', 'заряжаться', 'неисправный', 'подключение', 'разъединение', 'перегрев', 'неработающий', 'адаптер', 'провод'],
        'Материнская плата': ['плата', 'разъем', 'контакт', 'сгореть', 'перестать', 'работать', 'чип', 'сбой', 'система', 'BIOS', 'замыкание'],
        'Матрица': ['экран', 'дисплей', 'пятно', 'трещина', 'пиксель', 'мерцать', 'разбитый', 'полоса', 'яркость', 'цветопередача', 'темный'],
        'Вентилятор': ['кулер', 'охлаждение', 'перегрев', 'шум', 'чистка', 'пыль', 'неработать', 'вращение', 'засорение', 'нагрев', 'шуметь'],
        ...
        'Клавиатура': ['клавиша', 'неработать', 'залипание', 'кнопка', 'отклик', 'сломан', 'замена', 'шлейф', 'раскладка', 'неисправность', 'нажатие'],
        'Корпус': ['корпус'], 
